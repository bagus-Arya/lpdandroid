...
class LaporanSetoranBendaharaActivity : AppCompatActivity() {
    ...
    private var urls = "${baseUrl.url}/laporan/setoran/${loginData.token}"
...
//            Log.d("webview", contentLength.toString())
    ...
    fun savePDF(dataBase64:String){
        try {
            var filename="laporan-setoran_"+ randomString(5)+ ".pdf"
...
//                        window.navigationBarColor = Color.TRANSPARENT
    ...
    fun getAndUpdateTokenLoginData(){
        ...
        urls = "${baseUrl.url}/laporan/setoran/${loginData.token}"
    }
